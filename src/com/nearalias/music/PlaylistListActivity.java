 ...
 * (if present) is a {@link PlaylistDetailFragment}.
 * <p>
...
public class PlaylistListActivity extends FragmentActivity
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(PlaylistDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(PlaylistDetailFragment.ARG_ITEM_ID, id);
